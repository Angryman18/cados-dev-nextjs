    ...
    <div className="my-4">
      <ul className="decoration-none flex gap-x-0 text-white">
        <a
          ...
          href="#"
          className="block p-2.5 ml-0 leading-tight text-gray-500 bg-gray-800  rounded-l-lg   hover:text-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
        >
        ...
        >
          <a
            href="#"
            className="block p-2.5 leading-tight text-gray-500  rounded-r-lg  bg-gray-800  hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800  dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
          >
